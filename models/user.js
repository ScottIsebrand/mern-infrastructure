...
userSchema.pre('save', async function (next) {
  ...
  // "hash the [plain text] password," -- ie, update the plaintext password with the computed hash; await the bcrypt hash function that will return a promise, it will take some time
